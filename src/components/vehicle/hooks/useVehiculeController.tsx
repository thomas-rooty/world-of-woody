...
import {RapierRigidBody, useAfterPhysicsStep, useRapier} from '../../../lib/react-three-rapier'
...
export function useVehicleController(chassisRef: RefObject<RapierRigidBody>, wheelsRef: RefObject<Object3D[]>) {
    const {world} = useRapier()
    console.log(world)
    const [vehicleController, setVehicleController] = useState<DynamicRayCastVehicleController>()
    ...
    useEffect(() => {
        ...
        wheels.forEach((wheel) => {
            ...
            vehicle.addWheel(wheel.position, new Vector3(0, -1, 0), new Vector3(0, 0, 1), suspensionRestLength, radius)
        })
